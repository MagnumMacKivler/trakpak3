...
E2Helper.Descriptions["quickSetupAutoCouplers(e:nnn)"] = "Quickly adds AutoCouplers to carbody E. Tolerance is the max distance from the centerline required to couple. Slack is the amount of slack in the coupler (0 = Rigid). Returns the number of couplers successfully created."
