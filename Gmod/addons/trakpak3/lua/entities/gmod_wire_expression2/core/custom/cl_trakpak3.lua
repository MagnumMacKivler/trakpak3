...
E2Helper.Descriptions["getAutoCoupled(e:n)"] = "Returns car entity of the specified coupler that it is coupled to. Use 1 for the front coupler, -1 for the rear coupler. It will return NULL if you give an argument of 0 or the selected coupler is not coupled to anything."
