...
for k, filename in pairs(file.Find("trakpak3/signalsystems/*.lua","LUA")) do
	local json = file.Read("trakpak3/signalsystems/"..filename, "LUA")
	if json then
		print("[TP3Signals] Found file "..filename)
		local currentsys = {}
